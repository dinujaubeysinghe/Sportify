...
  // ===== Fetch products (FIXED: Added isActive filter) =====
  const { data: productsData, isLoading, error } = useQuery(
    ['products', searchQuery, filters, sortBy, currentPage],
    async () => {
      const params = new URLSearchParams();

      // --- CRITICAL FIX: Only fetch active products ---
...
  // ===== Fetch categories & brands for filters (No Change) =====
...
    // NOTE: Check the typo here in the original code. It had an extra '//'.
    // Assuming the correct endpoint is now used:
