...
const Register = () => {
  ...
  // Helper function to handle employee ID input
  ...
  const onSubmit = async (data) => {
    ...
    if (result.success) {
      if (selectedRole === 'staff') {
        // Staff users can login immediately
        navigate('/login');
      } else {
        // Other users need to verify email first
        navigate('/');
      }
    }
  };
              ...
              {selectedRole === 'staff' && (
                <>
                  <div>
                    ...
                    <input
                      {...register('employeeId', {
                        required: selectedRole === 'staff' ? 'Employee ID is required' : false,
                        pattern: {
                          value: /^[A-Z0-9]{3,10}$/,
                        ...
                        validate: {
                          notEmpty: (value) => {
                            if (selectedRole === 'staff' && value) {
                              return value.trim().length > 0 || 'Employee ID cannot be empty';
                            }
                            return true;
                          }
                        }
                      ...
                      className="mt-1 appearance-none rounded-lg relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                      placeholder="e.g., EMP001, STAFF123"
                  ...
                  <div>
                    ...
                    <select
                      {...register('department', {
                        required: selectedRole === 'staff' ? 'Department is required' : false,
                        validate: {
                          notDefault: (value) => {
                            if (selectedRole === 'staff' && value) {
                      ...
                      className="mt-1 appearance-none rounded-lg relative block w-full px-3 py-2 border border-gray-300 text-gray-900 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    >
                  ...
                  <div>
                    ...
                    <input
                      {...register('hireDate', {
                        required: selectedRole === 'staff' ? 'Hire date is required' : false,
                        validate: {
                          notFuture: (value) => {
                            if (selectedRole === 'staff' && value) {
                          ...
                          notTooOld: (value) => {
                            if (selectedRole === 'staff' && value) {
                              ...
                              return selectedDate >= tenYearsAgo || 'Hire date cannot be more than 10 years ago';
                            }
                            return true;
                          }
                        }
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Select the date when you started working
                    </p>
                  </div>
                </>
              )}
